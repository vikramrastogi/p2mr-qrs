...
- Benchmark commit recorded by the sample report:
  `34a1a1deb57f5c80bb1a893dca8265183a55e84b`
...
| --- | ---: | --- |
| QRS valid saturated block | 90.004 | available |
| QRS worst-observed invalid fixed-length saturated block | 103.130 | available |
| Individual BIP-340 Schnorr saturated block | 359.994 | available |
| Experimental batch BIP-340 Schnorr saturated block | 286.130 | available, sensitivity analysis only |
...
`all_ff`. The invalid-fixed-length bucket is a crypto bucket: every case keeps
