...
- Benchmark commit recorded by the sample report:
  `5eba230f958e28366e52bdcf020bf646e04b16ab`
...
| --- | ---: | --- |
| QRS valid saturated block | 93.231 | available |
| QRS worst-observed invalid fixed-length saturated block | 156.628 | available |
| Individual BIP-340 Schnorr saturated block | 386.586 | available |
| Experimental batch BIP-340 Schnorr saturated block | 507.659 | available, sensitivity analysis only |
...
`all_zero`. The invalid-fixed-length bucket is a crypto bucket: every case keeps
